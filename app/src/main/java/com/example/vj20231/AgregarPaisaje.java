...
public class AgregarPaisaje extends AppCompatActivity implements LocationListener {
        ...
        btnAgregar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!nombre.isEmpty() ) {
                    ...
                    TextView etLatitud = findViewById(R.id.etLatitud);
                    TextView etLongitud = findViewById(R.id.etLongitud);
                    ...
                    contact.setLatitude(latitud);
                    contact.setLongitude(longitud);
    ...
    private void agregarContactoConImagen(String imageUrl) {
        ...
        if (!nombre.isEmpty() ) {
            ...
            contact.setLatitude(latitude); // Asignar la latitud obtenida en onLocationChanged
            contact.setLongitude(longitude); // Asignar la longitud obtenida en onLocationChanged
            ...
            createCall.enqueue(new Callback<Contact>() {
                ...
                public void onResponse(Call<Contact> call, Response<Contact> response) {
                    if (response.isSuccessful()) {
                        Toast.makeText(AgregarPaisaje.this, "Paisaje agregado correctamente", Toast.LENGTH_SHORT).show();
