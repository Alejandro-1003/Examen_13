...
public class ActualizarPaisaje extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_actualizar_paisaje);
            ...
            llamada.enqueue(new Callback<Contact>() {
                ...
                public void onResponse(Call<Contact> call, Response<Contact> response) {
                    if (response.isSuccessful()) {
                        ...
                        Toast.makeText(ActualizarPaisaje.this, "Contacto actualizado exitosamente", Toast.LENGTH_SHORT).show();
                        setResult(RESULT_OK);
                        finish();
                        Intent intent = new Intent(ActualizarPaisaje.this, ListaPaisajeActivity.class);
                        startActivity(intent);
                    } else {
                        // Error en la actualización, muestra un mensaje de error o realiza una acción de manejo de errores
                        Toast.makeText(ActualizarPaisaje.this, "Error al actualizar el contacto", Toast.LENGTH_SHORT).show();
                    }
                }
                ...
                public void onFailure(Call<Contact> call, Throwable t) {
                    ...
                    Toast.makeText(ActualizarPaisaje.this, "Error al realizar la solicitud", Toast.LENGTH_SHORT).show();
                }
            });
        });
    }
